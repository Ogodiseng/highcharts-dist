/**
 * @license Highcharts Gantt JS v8.0.4 (2020-04-28)
 *
 * Gantt series
 *
...
(function (factory) {
    ...
    _registerModule(_modules, 'parts-gantt/TreeGridAxis.js', [_modules['parts/Axis.js'], _modules['parts-gantt/GridAxis.js'], _modules['parts/Tick.js'], _modules['parts-gantt/Tree.js'], _modules['parts-gantt/TreeGridTick.js'], _modules['mixins/tree-series.js'], _modules['parts/Utilities.js']], function (Axis, GridAxis, Tick, Tree, TreeGridTick, TreeSeriesMixin, U) {
        /* *
         *
         *  (c) 2016 Highsoft AS
         *  Authors: Jon Arild Nygard
    ...
    _registerModule(_modules, 'parts-gantt/GanttSeries.js', [_modules['parts/Axis.js'], _modules['parts/Globals.js'], _modules['parts-gantt/TreeGridAxis.js'], _modules['parts/Utilities.js']], function (Axis, H, TreeGridAxis, U) {
        /* *
         *
         *  (c) 2016-2020 Highsoft AS
         *
